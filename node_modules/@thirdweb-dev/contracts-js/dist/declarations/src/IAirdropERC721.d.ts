...
export interface IAirdropERC721 extends BaseContract {
    ...
    functions: {
        airdrop(tokenAddress: string, tokenOwner: string, contents: IAirdropERC721.AirdropContentStruct[], overrides?: Overrides & {
    ...
    callStatic: {
        airdrop(tokenAddress: string, tokenOwner: string, contents: IAirdropERC721.AirdropContentStruct[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {
