...
export interface IAirdropERC1155 extends BaseContract {
    ...
    functions: {
        airdrop(tokenAddress: string, tokenOwner: string, contents: IAirdropERC1155.AirdropContentStruct[], overrides?: Overrides & {
    ...
    callStatic: {
        airdrop(tokenAddress: string, tokenOwner: string, contents: IAirdropERC1155.AirdropContentStruct[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {
