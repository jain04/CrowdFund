...
export interface TokenBoundAccountInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addDeposit" | "contractURI" | "entryPoint" | "execute" | "executeBatch" | "executeCall" | "factory" | "getDeposit" | "getNonce" | "initialize" | "isValidSignature" | "isValidSigner" | "multicall" | "nonce" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "owner" | "setContractURI" | "supportsInterface" | "token" | "validateUserOp" | "withdrawDepositTo"): FunctionFragment;
...
export interface TokenBoundAccount extends BaseContract {
    ...
    functions: {
        ...
        isValidSigner(_signer: string, arg1: UserOperationStruct, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        isValidSigner(_signer: string, arg1: UserOperationStruct, overrides?: CallOverrides): Promise<BigNumber>;
        multicall(data: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        nonce(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isValidSigner(_signer: string, arg1: UserOperationStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        multicall(data: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
