...
export interface BaseRouterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addExtension" | "getAllExtensions" | "getAllFunctionsOfExtension" | "getExtension" | "getExtensionForFunction" | "getExtensionImplementation" | "getImplementationForFunction" | "removeExtension(((string,string,address),(bytes4,string)[]))" | "removeExtension(string)" | "supportsInterface" | "updateExtension"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "removeExtension(((string,string,address),(bytes4,string)[]))", values: [IExtension.ExtensionStruct]): string;
    encodeFunctionData(functionFragment: "removeExtension(string)", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "removeExtension(((string,string,address),(bytes4,string)[]))", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeExtension(string)", data: BytesLike): Result;
...
export interface BaseRouter extends BaseContract {
    ...
    functions: {
        ...
        "removeExtension(((string,string,address),(bytes4,string)[]))"(extension: IExtension.ExtensionStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "removeExtension(string)"(_extensionName: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getExtensionImplementation(_extensionName: string, overrides?: CallOverrides): Promise<string>;
        getImplementationForFunction(_functionSelector: BytesLike, overrides?: CallOverrides): Promise<string>;
        "removeExtension(((string,string,address),(bytes4,string)[]))"(extension: IExtension.ExtensionStruct, overrides?: CallOverrides): Promise<void>;
        "removeExtension(string)"(_extensionName: string, overrides?: CallOverrides): Promise<void>;
        supportsInterface(interfaceId: BytesLike, overrides?: CallOverrides): Promise<boolean>;
