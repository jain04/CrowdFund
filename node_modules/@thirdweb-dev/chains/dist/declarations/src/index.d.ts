...
export { default as Xpla } from "../chains/3701";
...
export { default as XplaXpla } from "../chains/37";
...
export declare const defaultChains: ({
    ...
    readonly name: "Base";
    readonly chain: "ETH";
    readonly rpc: readonly ["https://base.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://mainnet.base.org/", "https://developer-access-mainnet.base.org/", "https://base.gateway.tenderly.co", "wss://base.gateway.tenderly.co"];
    readonly faucets: readonly [];
    readonly nativeCurrency: {
        readonly name: "Ether";
        readonly symbol: "ETH";
    ...
    readonly chain: "ETH";
    readonly rpc: readonly ["https://base-goerli.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "wss://base-goerli.gateway.tenderly.co", "https://base-goerli.gateway.tenderly.co", "https://goerli.base.org"];
