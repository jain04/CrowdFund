...
import { SignerWithPermissions, SignerPermissionsInput, PermissionSnapshotInput } from "../../types";
...
export declare class Account<TContract extends IAccountCore> implements DetectableFeature {
     ...
     * @twfeature AccountPermissions
     */
    grantAdminPermissions(signerAddress: AddressOrEns): Promise<Omit<{
     ...
     * @twfeature AccountPermissions
     */
    revokeAdminPermissions(signerAddress: AddressOrEns): Promise<Omit<{
        receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
        data: () => Promise<unknown>;
    }, "data">>;
    /**
     ...
     * @twfeature AccountPermissions
     */
    grantPermissions(signerAddress: AddressOrEns, permissions: SignerPermissionsInput): Promise<Omit<{
        receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
        data: () => Promise<unknown>;
    }, "data">>;
    /**
     ...
     * @twfeature AccountPermissions
     */
    updatePermissions(signerAddress: AddressOrEns, permissions: SignerPermissionsInput): Promise<Omit<{
        receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
        data: () => Promise<unknown>;
    }, "data">>;
    /**
     ...
     * @twfeature AccountPermissions
     */
    revokeAccess(signerAddress: AddressOrEns): Promise<Omit<{
        receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
        data: () => Promise<unknown>;
    }, "data">>;
    /**
     ...
     * @twfeature AccountPermissions
     */
    approveTargetForSigner(signerAddress: AddressOrEns, target: AddressOrEns): Promise<Omit<{
        receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
        data: () => Promise<unknown>;
    }, "data">>;
    /**
     ...
     * @twfeature AccountPermissions
     */
    disapproveTargetForSigner(signerAddress: AddressOrEns, target: AddressOrEns): Promise<Omit<{
        receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
        data: () => Promise<unknown>;
    }, "data">>;
    /**
     ...
     * @twfeature AccountPermissions
     */
    resetAllPermissions(permissionSnapshot: PermissionSnapshotInput): Promise<Omit<{
        receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
        data: () => Promise<unknown>;
    }, "data">>;
}
